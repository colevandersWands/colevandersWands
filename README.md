...
AI can now write and explain code, but people still need to understand and maintain code. To adapt, programming education must center code comprehension, discussion, and review instead of writing. Coincidentally, research finds this is also the most effective way to learn programming. My open educational resources form a coherent approach to comprehension-first programming education centering self-study, easy content authoring, and offline study.
